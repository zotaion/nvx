...
do
	...
	local servers = {
		lua_ls = {},
		ts_ls = {
			-- Explicitly exclude HTML files - let angularls or html handle them
			filetypes = {
				"javascript",
				"javascriptreact",
				"javascript.jsx",
	...
	-- Angular language server with better diagnostic filtering
	lspconfig.angularls.setup({
		...
		on_attach = function(client, bufnr)
			-- Optional: disable specific capabilities if needed
